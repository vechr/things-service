...
export class EditDeviceDto {
  @ApiProperty({
    example: 'Arduino Uno Room A Edited',
    description: 'Insert your Device Name in Here!',
  })
  @IsString()
  @IsOptional()
  name?: string;
  ...
  @ApiProperty({
    example: 'Location Arduino Uno in Room A Edited',
    description: 'Insert your Device Description in Here!',
  })
  @IsString()
  @IsOptional()
  description?: string;
